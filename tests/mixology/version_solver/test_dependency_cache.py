...
def test_solver_dependency_cache_pulls_from_prior_level_cache(
    ...
    assert ("demo", None, None, None, None) in cache.cache
    assert ("demo", None, None, None, None) in cache.cached_dependencies_by_level[0]
    ...
    assert ("demo", None, None, None, None) in cache.cache
    assert ("demo", None, None, None, None) in cache.cached_dependencies_by_level[0]
    assert set(cache.cached_dependencies_by_level.keys()) == {0}
    ...
    assert ("demo", None, None, None, None) in cache.cache
    assert ("demo", None, None, None, None) in cache.cached_dependencies_by_level[0]
    assert ("demo", None, None, None, None) in cache.cached_dependencies_by_level[2]
    assert set(cache.cached_dependencies_by_level.keys()) == {0, 2}
    assert cache._search_for_cached.cache_info().hits == 1
